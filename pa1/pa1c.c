...
void Main ()
{
 ...
 // Printf("!!!1111111!Current process is: %d\n", Getpid());

	if ((pid = Fork ()) == 0) {

   // Printf("!!!222222222!!current process is: %d\n", Getpid());
 ...
 // Printf("!!33333333!!!current process is: %d\n", Getpid());
 ...
 // Printf("!!44444444!Current process is: %d\n", Getpid());
   ...
   // Printf("!55555555555!Current process is: %d\n", Getpid());
 ...
 // Printf("!666666666666!Current process is: %d\n", Getpid());
